...
Ce projet s'inscr dans un cadre académique, ainsi aucun budget spécifique ne lui est alloué. Il doit être développé avec des outils open source ou des versions gratuites. Comme un hébergement sur le cloud est nécessaire au bon fonctionnement du site web, nous devrons nous limiter à un usage d’offre gratuite.
...
\begin{itemize}
    ...
    \item Semaines 5-10 : développement
...
\begin{enumerate}[label=A.\arabic*, leftmargin=1.7cm]
    ...
    \label{SW}
        \begin{figure}[h]
            ...
            \begin{minipage}{0.48\textwidth}
                \centering
                \includegraphics[width=0.9\textwidth]{page_connexion (2).jpeg}
            \end{minipage}
    ...
    Voici les schémas des différents fichiers :
        ...
        \begin{table}[h]
            ...
            \begin{tabular}{@{}ll@{}}
                \toprule
                \textbf{Propriété (Colonne)} & \textbf{Type / Description} \\
                \midrule
                \textbf{adult} & (Bool)\\
...
\begin{itemize}
    ...
    \underline{NB} : Dans notre cas, nous utiliserons un algorithme de recommandation, qui permet proposer des contenus pertinents à un utilisateur.
    ...
    \item \underline{Frontend} : Le frontend est la partie visible du site web, c'est ce avec quoi l'utilisateur intéragit directement.
    ...
    \item \underline{Système de recommandation} : Un système de recommadation est un système qui permet de proposer des contenus pu des produits en fonction de ses préferences.
...
\begin{itemize}
    ...
    \item Saporta, Gilbert. Algorithmes de recommandation. Editions Technip, 2022, p. 247. cnam.hal.science,\\ \url{https://cnam.hal.science/hal-03696281}.
...
\begin{itemize}
    ...
    \item Contraintes \pageref{cont2}
    \item CSV \pageref{JD2},\pageref{BE2}
    \item Fonctionnalité \pageref{fnct}
